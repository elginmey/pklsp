...
<body>
    <div class="container mt-5">
        ...
        <div >
          <a href="https://linktr.ee/kontaklspsdmtik" class="btn btn-brand me-2">Kemitraan</a>
        </div>
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                <td><?= $index + 1 ?></td>
                <td><?= htmlspecialchars($mitra['nama'] ?? 'Tidak ada nama') ?></td>
                <td><?= htmlspecialchars($mitra['alamat'] ?? 'Tidak ada alamat') ?></td>
                <td><?= htmlspecialchars($mitra['kerja_sama'] ?? 'Tidak ada kerja sama') ?></td>
