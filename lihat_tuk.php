...
<div class="container-fluid mt-5">
    <h2 class="mb-4">Data Tempat Uji Kompetensi (TUK)</h2>
    <a href="https://docs.google.com/forms/d/e/1FAIpQLSc9Tbzp_Dmc6v79XDQs-BQxYBPkdVCaLIuVLDJ0BOxfkOwyEQ/viewform" target="_blank" class="btn btn-primary mb-3">Pendaftaran TUK</a>
    <div class="table-responsive">
        <table id="tukTable" class="table table-striped table-bordered nowrap">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Kode TUK</th>
   ...
   <footer class="bg-dark">
    ...
    #tukTable th, #tukTable td {
        white-space: normal;
        word-wrap: break-word;
        min-width: 100px; /* Sesuaikan nilai ini sesuai kebutuhan */
    }
    #tukTable td:nth-child(4) { /* Kolom alamat */
    ...
    $(document).ready(function() {
        $('#tukTable').DataTable({
            ...
            columnDefs: [
                ...
                { responsivePriority: 2, targets: 1 }, // Kode TUK
                { responsivePriority: 3, targets: 2 }, // Nama TUK
                { responsivePriority: 4, targets: 4 }, // Jenis TUK
